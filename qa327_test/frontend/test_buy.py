...
class FrontendBuyTest(BaseCase):
    ...
    def test_name_alphanumeric(self,*_):
        ...
        self.assert_text("The name of the ticket has to be alphanumeric only",selector='.message_error')
    ...
    def test_name_space_position(self,*_):
        ...
        self.assert_text("The name of the ticket is only allowed spaces if it is not the first or last character",selector='.message_error')
    ...
    def test_name_length(self,*_):
        ...
        self.assert_text("The name of the ticket should be no longer than 60 characters",selector='.message_error')
    ...
    def test_quantity_number_too_long(self,*_):
        ...
        self.assert_text("The quantity of the ticket must be between 1 and 100",selector='.message_error')
